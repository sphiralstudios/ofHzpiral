...
namespace ofxKCTouchGui {
    ...
    void Touch::setVoiceIndex (int vIndex) {
        this->voiceIndex = vIndex;
    }
    
    int Touch::getVoiceIndex () {
        return this->voiceIndex;
    }
    
    void Touch::setPolarLocation (PolarPoint polarPoint) {
        this->polarLocation = polarPoint;
    }
    
    PolarPoint Touch::getPolarLocation() {
        return this->polarLocation;
    }
