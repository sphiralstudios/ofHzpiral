...
#ifndef POLY_VOICES
#define POLY_VOICES 16 	// default is no polyphony (mono)
#endif
...
class FaustPolyEngine {
    ...
    protected:
        ...
        HzpVoice* fMonoDSP;          // the monophonic Faust object
...
//                fDriver->stop();
    ...
    // added computeAudio method to be called by ofApp::audioOut
        void computeAudio (int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
